...
Manage travel plans in `~/Library/Mobile Documents/iCloud~md~obsidian/Documents/Katz Vault/Travel/`.
...
2. **Create the file** at `~/Library/Mobile Documents/iCloud~md~obsidian/Documents/Katz Vault/Travel/{Trip Name}.md`
