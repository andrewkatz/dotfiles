---
name: obsidian-vault
description: Manage the Obsidian vault at ~/Library/Mobile Documents/iCloud~md~obsidian/Documents/Katz Vault - create, edit, and organize personal notes, projects, and travel plans
---

# Obsidian Vault Management

This skill teaches goose how to effectively manage the Obsidian vault located at `~/Library/Mobile Documents/iCloud~md~obsidian/Documents/Katz Vault`.

## Vault Structure

```
~/Library/Mobile Documents/iCloud~md~obsidian/Documents/Katz Vault/
...
For new top-level notes, create in the root `~/Library/Mobile Documents/iCloud~md~obsidian/Documents/Katz Vault/` directory with a descriptive name.
