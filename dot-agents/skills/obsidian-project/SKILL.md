...
Manage projects in `~/Library/Mobile Documents/iCloud~md~obsidian/Documents/Katz Vault/Projects/`.
...
2. **Create the file** at `~/Library/Mobile Documents/iCloud~md~obsidian/Documents/Katz Vault/Projects/{Project Name}.md`
