...
Add to `~/Library/Mobile Documents/iCloud~md~obsidian/Documents/Katz Vault/Notes.md` under the "Jot down some text" section:
...
Add to `~/Library/Mobile Documents/iCloud~md~obsidian/Documents/Katz Vault/Notes.md` under the "Make a to-do list" section:
...
Add to `~/Library/Mobile Documents/iCloud~md~obsidian/Documents/Katz Vault/Quotes.md`:
```markdown
> {The quote text}
> 
> - {Attribution}
...
Add to `~/Library/Mobile Documents/iCloud~md~obsidian/Documents/Katz Vault/Stuff I want.md`:
```markdown
